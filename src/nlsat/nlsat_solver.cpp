...
namespace nlsat {
    ...
    struct solver::imp {
        ...
        */
        void select_witness() {
            ...
            m_ism.peek_in_complement(m_infeasible[m_xk], m_is_int[m_xk], w, m_randomize);//返回interval_set的列表
            TRACE("nlsat", 
    ...
    // expr_ref solver::mk_ge(generic_model_converter& fm, theory_var v, inf_rational const& val){

    // }
    // solver::inf_eps solver::value(theory_var var){

    // }
    // solver::inf_eps solver::maximize(theory_var v, expr_ref& blocker, bool& has_shared){

    // }
    // theory_var solver::add_objective(app* term){
